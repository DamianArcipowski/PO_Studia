public class Cytryna extends Owoc {
    private String nazwa;
    private double cena;
    private int iloscNaMagazynie;

    public Cytryna(String nazwa, double cena, int iloscNaMagazynie) {
        this.nazwa = nazwa;
        this.cena = cena;
    ...
    @Override
    public void smak() {
        System.out.println("Smak jest kwaśny");
    }

    @Override
    public void umyj() {
        System.out.println("Cytryna została umyta");
    }

    @Override
    public void zjedz() {
        System.out.println("Cytryna została zjedzona");
    }
